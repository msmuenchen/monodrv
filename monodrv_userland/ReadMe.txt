========================================================================
    KONSOLENANWENDUNG: monodrv_userland-Projektübersicht
========================================================================

Diese monodrv_userland-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre monodrv_userland-Anwendung besteht.


monodrv_userland.vcxproj
...
monodrv_userland.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "monodrv_userland.pch und eine 
